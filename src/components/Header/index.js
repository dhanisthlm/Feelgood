            ...
            <div>
                ...
                <div className="categories">
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                         ...
                         ref="stres"
                         className="worry stres">
                        <p className="worry-text">Jeste li pod stresom i imate li poteškoće u rješavanju istih?</p>
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                        onMouseLeave={this.handleMouseLeave}
                        ref="sikiracija"
                        className="worry sikiracija">
                        <p className="worry-text">Osjećate li da se sikirate i da ne možete podnijeti brigu?</p>
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                         onMouseLeave={this.handleMouseLeave}
                         ref="iscrpljenost"
                         className="worry iscrpljenost">
                        <p className="worry-text">Imate li poteškoća sa spavanjem, umorom i iscrpljenjošću?</p>
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                         onMouseLeave={this.handleMouseLeave}
                         ref="tezina"
                         className="worry tezina">
                        <p className="worry-text">
                            Imate li problema sa tjelesnom težinom?
                        </p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
                            <g fill="#BC67A4">
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                         ...
                         ref="bol"
                         className="worry bol">
                        <p className="worry-text">Trebate li pomoć o olakšavanju bola?</p>
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                         onMouseLeave={this.handleMouseLeave}
                         ref="depresivno"
                         className="worry depresivno">
                        <p className="worry-text">
                            Osjećate li se tužno ili depresivno?
                        </p>
                    ...
                    <div onMouseEnter={this.handleMouseEnter}
                         onMouseLeave={this.handleMouseLeave}
                         ref="djete"
                         className="worry djete">
                        <p className="worry-text">Da li vaše dijete ima izlive bijesa?</p>
                    ...
                    <div className="row-3">
                        <div onMouseEnter={this.handleMouseEnter}
                             onMouseLeave={this.handleMouseLeave}
                             ref="panika"
                             className="worry panika">
                            <p className="worry-text">
                                Osjecate li anksioznost ili napad panike?
                            </p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="452" height="309" viewBox="0 0 452 309">
                                <path fill-rule="evenodd" clip-rule="evenodd" fill="#C04C9C" d="M121.103 7.018c14.866 0 29.227.062 43.587-.02 12.633-.068 24.65 3.165 36.928 5.58 10.76 2.114 20.74 5.984 30.91 9.378 7.384 2.464 14.175 6.843 21.026 10.73C271.71 42.98 287.3 56.42 300.784 72.293c11.174 13.158 20.463 27.617 27.46 43.368 4.694 10.566 8.667 21.5 12.23 32.506 2.16 6.668 3.045 13.767 4.285 20.71 1.812 10.166 3.7 20.33 5.033 30.564.83 6.38.99 12.886.927 19.33-.094 9.467 2.845 11.58 12.34 14.642 9.637 3.106 19.237 7.072 27.907 12.247 12.755 7.614 24.48 16.84 33.655 28.854 3.254 4.26 3.02 5.966-1.492 8.52-3.28 1.858-6.574 3.702-9.756 5.72-2.834 1.798-4.953 1.157-6.83-1.4-9.697-13.21-22.433-22.477-37.47-28.708-7.222-2.992-14.304-6.53-21.782-8.628-7.676-2.154-15.725-3.135-23.672-4.115-8.35-1.03-16.832-2.417-25.154-1.923-13.934.827-27.81 2.85-41.664 4.713-7.443 1-14.943 2.185-22.148 4.233-10.922 3.106-21.735 6.703-32.364 10.704-13.342 5.02-26.424 10.73-39.672 16.012-9.406 3.748-18.718 7.885-28.394 10.77-18.168 5.422-36.375 8.292-55.325 1.92-13.166-4.426-23.7-12.31-34-20.898-.97-.81-.82-3.444-.528-5.115.19-1.077 1.522-2.017 2.466-2.883 3.312-3.04 6.497-8.1 10.076-8.41 3.256-.283 6.875 4.744 10.488 7.206 10.16 6.923 21.216 11.827 33.552 12.815 4.315.345 8.776-1.026 13.16-1.692 1.783-.27 3.546-1.118 5.3-1.066 5.5.16 8.317-3.314 9.485-7.724 2.766-10.445 5.402-20.97 7.23-31.61 3.033-17.66 5.39-35.437 8.027-53.166.05-.328.034-.666.042-1 .344-15.614 1.31-31.25.852-46.84-.424-14.492-1.98-28.985-3.752-43.39-1.5-12.196-3.39-24.42-6.272-36.352-2.833-11.73-7.143-23.105-10.777-34.646-1.016-3.23-1.94-6.49-3.147-10.544z"/>
                            </svg>
                        </div>
                        <div onMouseEnter={this.handleMouseEnter}
                             onMouseLeave={this.handleMouseLeave}
                             ref="fobia"
                             className="worry fobia">
                            <p className="worry-text">
                                Imate li fobije koje vas sprečavaju u životu?
                            </p>
                        ...
                        <div onMouseEnter={this.handleMouseEnter}
                             onMouseLeave={this.handleMouseLeave}
                             ref="sukob"
                             className="worry sukob">
                            <p className="worry-text">
                                Ulazite li lako u sukobe i jeste li frustrirani?
                            </p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="408" height="417" viewBox="0 0 408 417">
                                <g fill-rule="evenodd" clip-rule="evenodd" fill="#C04C9C">
                        ...
                        <div onMouseEnter={this.handleMouseEnter}
                             onMouseLeave={this.handleMouseLeave}
                             ref="zaglavili"
                             className="worry zaglavili">
                            <p className="worry-text">
                                Jeste li zaglavili osobno ili profesionalno?
                            </p>
                ...
                <div className="hero-text">
                    <h3>Uzmite prvi korak za bolje sutra</h3>
                    <p>Da biste pronašli rješenja za svoju situaciju, može vam biti korisno potražiti stručnu podršku i pomoć. Kontaktirajte nas, mi možemo pomoći.</p>
