        ...
        return (
            <div className="page contact">
                ...
                <div className="wrapper">
                    ...
                    <p className="text">Našu službu za korisnike možete kontaktirati putem emaila, Skypea ili pozivom na sljedeće telefonske brojeve:</p>
                    <p className="text">E-pošta: <span className="email">zdravlje.nu@hotmail.com</span></p>
