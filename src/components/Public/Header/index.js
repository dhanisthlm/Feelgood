...
export class Header extends Component {
    constructor (props) {
        ...
        this.activateAdminMenu = this.activateAdminMenu.bind(this);
    }
        ...
        return (
            <div>
                <nav className="main-menu">
                    <Link to={issueHref}>{ t('services') }</Link>
    ...
    renderAdminMenu () {
        ...
        return (
            <div>
                <nav className="main-menu">
                    <Link className={`menuitem${this.state.adminActive === 'admin' ? '-active' : ''}`} id="sessions" onClick={this.activateAdminMenu} to='/admin'>Sesija</Link>
                    <Link className={`menuitem${this.state.adminActive === 'workshop' ? '-active' : ''}`} id="workshop" onClick={this.activateAdminMenu} to="/workshop">Radionica</Link>
                    <Link className={`menuitem${this.state.adminActive === 'newsletters' ? '-active' : ''}`} id="newsletters" onClick={this.activateAdminMenu} to="/newsletters">E-pošta lista</Link>
                    <Link className={`menuitem${this.state.adminActive === 'messages' ? '-active' : ''}`} id="messages" onClick={this.activateAdminMenu} to="/messages">Poruke</Link>
                </nav>
                <div id="topNav" className="navigation">
                    <span id="closebtn" onClick={this.navToggle}>
                    <span className="line1" />
                    ...
                    <ul className="menulist">
                        <li><Link className="menuitems" to="/admin">Sesija</Link></li>
                        <li><Link className="menuitems" to="/workshop">Radionica</Link></li>
                        <li><Link className="menuitems" to="/newsletters">E-pošta lista</Link></li>
                        <li><Link className="menuitems" to="/messages">Poruke</Link></li>
                    </ul>
                </div>
            </div>
        )
    ...
    render () {
        ...
        const logoutBtn = (this.props.location.pathname === '/admin' || this.props.location.pathname === '/newsletters' || this.props.location.pathname === '/workshop')
            ? 'auth-controls is-visible' : 'auth-controls is-hidden';

        return (
            <header className={headerClass}>
                <div className={logoutBtn}>
                    <a className="auth" onClick={this.handleLogout}>Odjaviti se</a>
                </div>
                <div className="logo-text">
                    <Link to="/kontakt">{ t('contactUs') }</Link>
                    <Link to="/hitna-pomoc">{ t('emergency') }</Link>
                </div>
